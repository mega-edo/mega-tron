...
AGENTS_BLOCK_BODY = (
    ...
    "their absolute paths, descriptions, the must-use trigger rule, and the\n"
    "self-evaluation contract. Follow that block when it appears.\n"
    "\n"
    ...
    "`--output bodies` to dump each pick's full SKILL.md instead. Read what\n"
    "it prints, then act on the matching SKILL.md's instructions.\n"
    "\n"
